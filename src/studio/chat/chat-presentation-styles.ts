...
export const styles = StyleSheet.create({
  ...
  inputShellShadow: { alignSelf: 'center', borderRadius: 20, maxWidth: 920, shadowOffset: { height: 2, width: 0 }, shadowOpacity: 0.12, shadowRadius: 8, width: '100%' },
  inputShell: { borderRadius: 20, flexDirection: 'column', minHeight: 102, overflow: 'hidden', position: 'relative', width: '100%' },
  ...
  openMinisInput: { backgroundColor: 'transparent', borderColor: 'transparent', borderWidth: 0, fontFamily: BODY_REGULAR, fontSize: 16, letterSpacing: 0, lineHeight: 23, maxHeight: 120, minHeight: 54, outlineColor: 'transparent', outlineStyle: 'solid', outlineWidth: 0, paddingBottom: 10, paddingHorizontal: 16, paddingTop: 16, textAlignVertical: 'top' },
  openMinisVoiceInput: { gap: 6, minHeight: 78, paddingBottom: 10, paddingHorizontal: 16, paddingTop: 11 },
  ...
  openMinisToolbar: { alignItems: 'center', flexDirection: 'row', gap: 12, minHeight: 44, paddingBottom: 10, paddingHorizontal: 12 },
  openMinisToolbarSpacer: { flex: 1, minWidth: 0 },
  openMinisRoundControl: { alignItems: 'center', borderRadius: 17, borderWidth: StyleSheet.hairlineWidth, height: 34, justifyContent: 'center', width: 34 },
  openMinisPlusGlyph: { fontFamily: BODY_MEDIUM, fontSize: 22, lineHeight: 24, textAlign: 'center' },
  openMinisSlashGlyph: { fontFamily: BODY_SEMIBOLD, fontSize: 18, fontStyle: 'italic', lineHeight: 22, textAlign: 'center' },
  openMinisReadAloud: { alignItems: 'center', borderRadius: 17, flexDirection: 'row', gap: 5, minHeight: 30, paddingHorizontal: 10 },
  openMinisReadAloudText: { fontFamily: BODY_REGULAR, fontSize: 12, lineHeight: 16 },
  openMinisSendControl: { alignItems: 'center', borderRadius: 17, height: 34, justifyContent: 'center', width: 34 },
  openMinisSendFallbackCircle: { alignItems: 'center', borderRadius: 17, height: 34, justifyContent: 'center', width: 34 },
  openMinisSendFallback: { fontFamily: BODY_SEMIBOLD, fontSize: 19, lineHeight: 22, textAlign: 'center' },
