...
export const styles = StyleSheet.create({
  ...
  header: { borderBottomWidth: 1, gap: 7, paddingBottom: 7 },
  headerRow: { alignItems: 'center', flexDirection: 'row', gap: 8, minHeight: 36 },
  chatModes: { alignItems: 'center', borderRadius: 8, borderWidth: 1, flexDirection: 'row', gap: 2, padding: 2 },
  chatMode: { alignItems: 'center', borderRadius: 6, flexDirection: 'row', gap: 4, minHeight: 32, paddingHorizontal: 9 },
  heading: { alignItems: 'center', flex: 1, flexDirection: 'row', gap: 9, minWidth: 0 },
  ...
  gatewayStatuses: { flexDirection: 'row', flexWrap: 'wrap', rowGap: 4, width: 244 },
  gatewayStatusRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 5, minHeight: 27, paddingHorizontal: 4, width: '50%' },
  gatewayStatusDot: { borderRadius: 3, height: 6, width: 6 },
  gatewayStatusLabel: { fontFamily: BODY_REGULAR, fontSize: 10, lineHeight: 14 },
  gatewayStatusVersion: { fontFamily: MONO_REGULAR, fontSize: 9, lineHeight: 12 },
  ...
  rosterTimeline: { borderLeftWidth: StyleSheet.hairlineWidth, gap: 3, marginLeft: 8, paddingLeft: 8, paddingTop: 3 },
  rosterEventRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 6 },
  rosterEventIndex: { fontFamily: MONO_REGULAR, fontSize: 8.5, lineHeight: 13, marginTop: 1 },
  rosterEventText: { flex: 1, fontFamily: BODY_REGULAR, fontSize: 10, lineHeight: 14 },
  contextUsageRow: { alignItems: 'center', alignSelf: 'stretch', flexDirection: 'row', justifyContent: 'flex-end', minHeight: 32, paddingHorizontal: 8 },
  contextRing: { alignItems: 'center', borderRadius: 14, borderWidth: StyleSheet.hairlineWidth, flexDirection: 'row', gap: 3, height: 28, justifyContent: 'center', minWidth: 72, paddingHorizontal: 7 },
  contextRingText: { fontFamily: MONO_REGULAR, fontSize: 9, lineHeight: 12 },
  contextRingLabel: { fontFamily: BODY_REGULAR, fontSize: 8, lineHeight: 11 },
  reworkBadge: { borderRadius: 5, paddingHorizontal: 5, paddingVertical: 1 },
  reworkBadgeText: { fontFamily: BODY_SEMIBOLD, fontSize: 8.5, lineHeight: 12 },
