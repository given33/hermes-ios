...
export const styles = StyleSheet.create({
  ...
  openMinisInput: { backgroundColor: 'transparent', borderColor: 'transparent', borderWidth: 0, fontFamily: MONO_REGULAR, fontSize: 16, letterSpacing: 0, lineHeight: 22, maxHeight: 120, minHeight: 54, outlineColor: 'transparent', outlineStyle: 'solid', outlineWidth: 0, paddingBottom: 8, paddingHorizontal: 16, paddingTop: 16, textAlignVertical: 'top' },
  ...
  openMinisToolbar: { alignItems: 'center', flexDirection: 'row', gap: 4, minHeight: 50, paddingBottom: 8, paddingHorizontal: 8 },
  openMinisToolbarSpacer: { flex: 1, minWidth: 0 },
  openMinisRoundControl: { alignItems: 'center', borderRadius: 21, borderWidth: 0, height: 42, justifyContent: 'center', width: 42 },
  openMinisSendControl: { alignItems: 'center', borderRadius: 21, height: 42, justifyContent: 'center', marginLeft: 6, width: 42 },
  openMinisSendFallbackCircle: { alignItems: 'center', borderRadius: 21, height: 42, justifyContent: 'center', width: 42 },
