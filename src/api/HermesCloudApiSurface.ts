...
export interface HermesCloudApi {
  getMemoryStatus(): Promise<JsonRecord>; setMemoryProvider(provider: string): Promise<JsonRecord>;
  resetMemory(target?: 'all' | 'memory' | 'user'): Promise<JsonRecord>;
  ...
  checkHermesUpdate(): Promise<JsonRecord>; getHermesUpdateReceipt(): Promise<JsonRecord>; getHealth(): Promise<JsonRecord>; getEgressStatus(): Promise<JsonRecord>;
...
Object.assign(CloudApi.prototype, {
  getMemoryStatus(this: any) { return this.memory.getMemoryStatus(); }, setMemoryProvider(this: any, p: string) { return this.memory.setMemoryProvider(p); }, resetMemory(this: any, t = 'all') { return this.memory.resetMemory(t); }, getMemoryProviderConfig(this: any, n: string, p = 'default', s = '') { return this.memory.getMemoryProviderConfig(n, p, s); }, setupMemoryProvider(this: any, n: string, v = {}) { return this.memory.setupMemoryProvider(n, v); }, updateMemoryProviderConfig(this: any, n: string, v: JsonRecord, p = 'default', s = '') { return this.memory.updateMemoryProviderConfig(n, v, p, s); },
