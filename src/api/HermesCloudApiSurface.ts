...
export interface HermesCloudApi {
  ...
  runDoctor(payload?: JsonRecord): Promise<JsonRecord>; runSecurityAudit(payload?: JsonRecord): Promise<JsonRecord>; createBackup(payload?: JsonRecord): Promise<JsonRecord>; downloadBackup(archive: string): Promise<Blob>;
