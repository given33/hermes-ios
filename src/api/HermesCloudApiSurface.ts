...
export interface HermesCloudApi {
  ...
  streamFile(path: string, signal?: AbortSignal): Promise<Blob>; listFilesystem(path?: string, depth?: number): Promise<JsonRecord>;
  readFilesystemText(path: string): Promise<JsonRecord>; writeFilesystemText(path: string, content: string): Promise<JsonRecord>;
  readFilesystemDataUrl(path: string): Promise<JsonRecord>; downloadFilesystem(path: string): Promise<Blob>;
  ...
  getProviderOauth(profile?: string): Promise<JsonRecord>; startProviderOauth(provider: string, body?: JsonRecord, profile?: string): Promise<JsonRecord>;
  submitProviderOauth(provider: string, body: JsonRecord, profile?: string): Promise<JsonRecord>; pollProviderOauth(provider: string, sessionId: string, profile?: string): Promise<JsonRecord>;
  cancelProviderOauth(sessionId: string, profile?: string): Promise<JsonRecord>;
  ...
  replaceMcpServers(servers: Record<string, JsonRecord>, profile?: string): Promise<{ ok: boolean }>;
  ...
  getCredentialPool(profile?: string): Promise<JsonRecord>; addCredentialPoolEntry(provider: string, apiKey: string, label?: string, profile?: string): Promise<JsonRecord>;
  removeCredentialPoolEntry(provider: string, index: number, profile?: string): Promise<JsonRecord>;
  getMedia(path: string): Promise<JsonRecord>; uploadChatImage(dataUrl: string, mimeType: string, filename?: string, profile?: string): Promise<JsonRecord>;
  ...
  runDoctor(payload?: JsonRecord): Promise<JsonRecord>; runSecurityAudit(payload?: JsonRecord): Promise<JsonRecord>; createBackup(payload?: JsonRecord): Promise<JsonRecord>;
  consumeBackup<T>(archive: string, consume: (response: Response, signal: AbortSignal) => Promise<T>, signal?: AbortSignal): Promise<T>;
  ...
  consumeKanbanAttachment<T>(id: number | string, consume: (response: Response, signal: AbortSignal) => Promise<T>, options?: { board?: string; expectedBytes?: number; signal?: AbortSignal }): Promise<T>;
  ...
  executeMobileHostedCommand(conversationId: string, command: MobileHostedCommand, text?: string, value?: string, confirmExpensiveModel?: boolean): Promise<MobileHostedCommandResult>;
}
}
...
Object.assign(CloudApi.prototype, {
  ...
  consumeKanbanAttachment<T>(this: any, i: number | string, c: (response: Response, signal: AbortSignal) => Promise<T>, o = {}) { return this.collaboration.consumeKanbanAttachment(i, c, o); },
