...
enum HermesRouteAction: String, CaseIterable {
  ...
  case providerOauthDisconnect = "provider.oauth.disconnect"
  ...
  case kanbanBoardCreate = "kanban.board.create"
  case kanbanBoardUpdate = "kanban.board.update"
  case kanbanBoardDelete = "kanban.board.delete"
  case kanbanBoardExport = "kanban.board.export"
  case kanbanBoardImport = "kanban.board.import"
  case kanbanOrchestrationUpdate = "kanban.orchestration.update"
